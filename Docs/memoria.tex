...
\newcommand{\nombre}{Pablo Alejos Salamanca} %%% cambio de comando

% Datos de portada
\title{Creación de un videojuego y un bot inteligente para el mismo}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 71302468, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado «Creación de un videojuego y un bot inteligente para el mismo». 
