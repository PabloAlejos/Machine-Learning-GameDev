...
\begin{abstract}
The purponse of this project is the developement of a videogame and then, using machine learning techniques, implement a few inteligent agents allow the computer play the game by itslelf.
\end{abstract}

\renewcommand*\abstractname{Keywords}
\begin{abstract}
Data mining, Videogame, Machine Learning
\end{abstract} 
